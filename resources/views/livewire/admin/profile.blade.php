...
<!--            <span class="bottom-2 right-4 absolute w-3.5 h-3.5 bg-green-400 border-2 border-white dark:border-gray-800 rounded-full"></span>-->
          ...
          <!-- User Meta -->
          <div>
            <h1 class="font-bold md:text-2xl">{{$authUser->first_name .' '. $authUser->last_name }} </h1>
            <p class="text-gray-700">{{$authUser->bio }} </p>
          </div>
          <!-- / User Meta -->
        </div>
        <!-- /Profile Info -->
        ...
        <div
          ...
          <div class="flex flex-col justify-center items-center">
            ...
            <p class="text-gray-600">Post{{$posts->count() > 0 ? 's' : ''}}</p>
          </div>
