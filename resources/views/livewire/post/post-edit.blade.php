          ...
          <div class="flex items-start /space-x-3/">
            ...
            <div class="text-gray-700 font-normal w-full">
                ...
                <div class="image-preview">
                    <img src="{{ $form->picture->temporaryUrl() }}" alt="Image preview" style="max-width: 100; max-height: 200px;">
                </div>
...
<!--                </button>-->
            ...
            <div>
              <!-- Post Button -->
              <button
                    wire:loading.attr="disable" wire:target="form.picture"
